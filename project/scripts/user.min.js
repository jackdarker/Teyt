...
window.gm.initGame = function (forceReset) {
  ...
  if (!s.Ratchel || forceReset) {
    ...
    //perklevels ,name should match perkId
    s.Ratchel.skSporty = 0, s.Ratchel.skCook = 0, s.Ratchel.skSlacker = 0, s.Ratchel.skMoneymaker = 0, s.Ratchel.skTechy = 0, window.gm.Ratchel = new Character(s.Ratchel);
...
window.gm.printShopBuyEntry = function (itemid, itemleft, cbCanBuy) {
  ...
  if (itemleft > 0) {
    ...
    if (result.OK === false) {
      desc2 = desc2 + " " + result.msg + "</br>";
    } else {
      desc2 += " " + result.msg;

      var foo = function foo($event) {
        window.gm.buyFromShop(itemid, itemleft, cbPostBuy);
      }; //(function(item){result.postBuy.fn(itemid,result.postBuy.cost)}))};
...
//should return {OK:true,msg:'',postBuy:null} where message will be displayed either as reason why you cannot buy or as cost
//postboy is {fn:foo, cost:x} where fn points to a function that is called after buying (fn(itemid,x));  
...
window.gm.buyFromShop = function (itemid, itemleft) {
  var cbPostBuy = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
...
var CanOfCoffee = /*#__PURE__*/function (_Item4) {
  _inherits(CanOfCoffee, _Item4);

  var _super4 = _createSuper(CanOfCoffee);
  ...
  function CanOfCoffee() {
    ...
    _this4 = _super4.call(this, 'Can of coffee');
    _this4.desc = 'Cold coffee in a can. Tasty? Not really!';
    return _this4;
  }
...
var SimpleFood = /*#__PURE__*/function (_Item5) {
  _inherits(SimpleFood, _Item5);

  var _super5 = _createSuper(SimpleFood);
  ...
  function SimpleFood() {
    ...
    _this5 = _super5.call(this, 'Simple food');
    _this5.desc = 'Something to eat.';
    return _this5;
  }
...
var Leggings = /*#__PURE__*/function (_Equipment) {
  ...
  var _super6 = _createSuper(Leggings);
  ...
  function Leggings() {
    ...
    _this6 = _super6.call(this, 'Leggings');
    _this6.tags = ['cloth'];
    _this6.slotUse = ['Legs'];
    _this6.desc = 'Spandex-leggings for sport. (agility+)';
    return _this6;
  }
...
var Jeans = /*#__PURE__*/function (_Equipment2) {
  ...
  var _super7 = _createSuper(Jeans);
  ...
  function Jeans() {
    ...
    _this7 = _super7.call(this, 'Jeans');
    _this7.tags = ['cloth'];
    _this7.slotUse = ['Legs'];
    return _this7;
  }
...
var TankShirt = /*#__PURE__*/function (_Equipment3) {
  ...
  var _super8 = _createSuper(TankShirt);
  ...
  function TankShirt() {
    ...
    _this8 = _super8.call(this, 'Tank-shirt');
    _this8.tags = ['cloth'];
    _this8.slotUse = ['Torso'];
    return _this8;
  }
...
var Pullover = /*#__PURE__*/function (_Equipment4) {
  ...
  var _super9 = _createSuper(Pullover);
  ...
  function Pullover() {
    ...
    _this9 = _super9.call(this, 'Pullover');
    _this9.tags = ['cloth'];
    _this9.slotUse = ['Torso', 'Arms'];
    return _this9;
  }
...
var Crowbar = /*#__PURE__*/function (_Equipment5) {
  ...
  var _super10 = _createSuper(Crowbar);
  ...
  function Crowbar() {
    ...
    _this10 = _super10.call(this, 'Crowbar');
    _this10.desc = 'A durable crowbar.';
    _this10.tags = ['tool', 'weapon'];
    _this10.slotUse = ['RHand'];
    return _this10;
  }
...
window.storage = {
  ...
  Reviver: function Reviver(key, value) {
    ...
    if (_typeof(value) === "object" && typeof value.ctor === "string" && typeof value.data !== "undefined") {
...
var StatsDictionary = /*#__PURE__*/function (_Inventory) {
  ...
  var _super11 = _createSuper(StatsDictionary);
...
var stArousal = /*#__PURE__*/function () {
  function stArousal() {
  ...
  _createClass(stArousal, null, [{
    ...
    value: function setup(context, base, max) {
      ...
      if (context.findItemSlot(_n.id) < 0) context.list.push(_n);
      _n = Stat.dataPrototype();
      _n.id = 'arousal', _n.base = base, _n.value = base, _n.limits = [{
        max: 'arousalMax',
        min: 'arousalMin'
      }];
      if (context.findItemSlot(_n.id) < 0) context.list.push(_n);
...
var stPerversion = /*#__PURE__*/function () {
  ...
  _createClass(stPerversion, null, [{
    ...
    value: function setup(context, base, max) {
      ...
      if (context.findItemSlot(_n.id) < 0) context.list.push(_n);
      _n = Stat.dataPrototype();
      _n.id = 'perversion', _n.base = base, _n.value = base, _n.limits = [{
        max: 'perversionMax',
        min: ''
      }];
      if (context.findItemSlot(_n.id) < 0) context.list.push(_n);
...
var Effects = /*#__PURE__*/function (_Inventory2) {
  ...
  var _super12 = _createSuper(Effects);

  //Todo a collection of Stats is similiar to Inventory?
  function Effects(owner, externlist) {
    _classCallCheck(this, Effects);

    return _super12.call(this, owner, externlist);
  } //override
...
var effEnergized = /*#__PURE__*/function (_Effect) {
  ...
  var _super13 = _createSuper(effEnergized);
...
var effNotTired = /*#__PURE__*/function (_Effect2) {
  ...
  var _super14 = _createSuper(effNotTired);
...
var effTired = /*#__PURE__*/function (_Effect3) {
  ...
  var _super15 = _createSuper(effTired);
...
var skCooking = /*#__PURE__*/function (_Effect4) {
  ...
  var _super16 = _createSuper(skCooking);
...
var skAnalReceiving = /*#__PURE__*/function (_Effect5) {
  ...
  var _super17 = _createSuper(skAnalReceiving);
