...
window.gm.combat.printCombatOption = function () {
  ...
  elmt += "<a0 id='moveStun'           onclick='(function($event){window.gm.combat.triggerCombat($event.id);})(this);'>Stun</a></br>"; //elmt +="<a0 id='showItems' onclick='(function($event){window.gm.execCombatCmd($event.id);"+next+"})(this);'>Item</a></br>";
...
window.gm.combat.startRound = function () {
  ...
  for (var k = 0; k < list.length; k++) {
    ...
    for (var i = 0; i < effects.length; i++) {
      ...
      if (_typeof(effect) === CombatEffect) {//list[k].Effects.(effects[i]);
      }
    }
  }
};
...
window.gm.combat.endCombat = function () {
  ...
  for (var k = 0; k < list.length; k++) {
    ...
    for (var i = 0; i < effects.length; i++) {
      ...
      if (_typeof(effect) === CombatEffect) {
...
window.gm.initGame = function (forceReset) {
  ...
  if (!s.vars || forceReset) {
    ...
    s.vars = (_s$vars = {
      ...
      qUnlockDowntown: 0,
      qUnlockRedlight: 0
    }, _defineProperty(_s$vars, "qUnlockBeach", 0), _defineProperty(_s$vars, "debugInv", new Inventory2()), _s$vars);

    s.vars.debugInv._parent = function () {
      return function () {
        return null;
      };
    }();
  ...
  if (!s.enemy || forceReset) {
    //actual/last enemy
    s.enemy = Character.defaultData(); //window.gm.enemy = new Character(s.enemy);
  ...
  if (!s.Ratchel || forceReset) {
    ...
    window.gm.Ratchel.Effects.addItem('Cooking', window.gm.EffectLib.Cooking); //add some basic inventory
    ...
    s.Ratchel = window.gm.Ratchel; //delete window.gm.Ratchel;
  }
...
window.gm.switchPlayer = function (playername) {
  var s = window.story.state;
  window.gm.player = s.player = s[playername]; //window.gm.player = new Character(s.player);
...
window.gm = window.gm || {}; //updates all panels
...
window.gm.pickupAndClear = function (itemid, desc, itemleft) {
  var cbAfterPickup = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
  window.gm.player.Inv.addItem(itemid); //window.gm.pushLog("added "+itemid+" to inventory.</br>");
...
var Character = /*#__PURE__*/function () {
  ...
  function Character(externlist) {
    ...
    this.Outfit._parent = function (me) {
      return function () {
        return me;
      };
    }(this);
    ...
    this.Wardrobe._parent = function (me) {
      return function () {
        return me;
      };
    }(this);
    ...
    this.Stats._parent = function (me) {
      return function () {
        return me;
      };
    }(this);
    ...
    this.Effects._parent = function (me) {
      return function () {
        return me;
      };
    }(this);
    ...
    this.Rel._parent = function (me) {
      return function () {
        return me;
      };
    }(this); //create basic stats
  ...
  _createClass(Character, [{
    ...
    value: function fromJSON(value) {
      return window.storage.Generic_fromJSON(Character, value.data);
    }
  }]);
...
var Inventory = /*#__PURE__*/function () {
  ...
  _createClass(Inventory, [{
    ...
    key: "fromJSON",
    value: function fromJSON(value) {
      return window.storage.Generic_fromJSON(Inventory, value.data);
    }
  }]);
...
var Inventory2 = /*#__PURE__*/function () {
  function Inventory2(externlist) {
  ...
  _createClass(Inventory2, [{
    key: "toJSON",
    value: function toJSON() {
      return window.storage.Generic_toJSON("Inventory2", this);
    }
  }, {
    key: "postItemChange",
    ...
    key: "fromJSON",
    value: function fromJSON(value) {
      return window.storage.Generic_fromJSON(Inventory2, value.data);
    }
  }]);
...
var Leggings = /*#__PURE__*/function (_Equipment) {
  ...
  var _super12 = _createSuper(Leggings);
  ...
  function Leggings() {
    ...
    _this11 = _super12.call(this, 'Leggings');
    _this11.tags = ['cloth'];
    _this11.slotUse = ['Legs'];
    _this11.desc = 'Spandex-leggings for sport. (agility+)';
    return _this11;
  }
...
var Jeans = /*#__PURE__*/function (_Equipment2) {
  ...
  var _super13 = _createSuper(Jeans);
  ...
  function Jeans() {
    ...
    _this12 = _super13.call(this, 'Jeans');
    _this12.tags = ['cloth'];
...
var TankShirt = /*#__PURE__*/function (_Equipment3) {
  ...
  var _super14 = _createSuper(TankShirt);
  ...
  function TankShirt() {
    ...
    _this13 = _super14.call(this, 'Tank-shirt');
    _this13.tags = ['cloth'];
    _this13.slotUse = ['Torso'];
    return _this13;
  }
...
var Pullover = /*#__PURE__*/function (_Equipment4) {
  ...
  var _super15 = _createSuper(Pullover);
  ...
  function Pullover() {
    ...
    _this14 = _super15.call(this, 'Pullover');
    _this14.tags = ['cloth'];
    _this14.slotUse = ['Torso', 'Arms'];
    return _this14;
  }
...
var Crowbar = /*#__PURE__*/function (_Equipment5) {
  ...
  var _super16 = _createSuper(Crowbar);
  ...
  function Crowbar() {
    ...
    _this15 = _super16.call(this, 'Crowbar');
    _this15.desc = 'A durable crowbar.';
    _this15.tags = ['tool', 'weapon'];
    _this15.slotUse = ['RHand'];
    return _this15;
  }
...
window.storage = {
  ...
  saveBrowser: function saveBrowser(slot) {
    ...
    var hash = LZString.compressToBase64(JSON.stringify({
      ...
      history: window.story.history,
      checkpointName: window.story.checkpointName
    })); //,window.storage._replacerFunc()));          //Todo
  ...
  rebuildFromSave: function rebuildFromSave(hash, compressed) {
    if (!compressed) hash = LZString.compressToBase64(hash); //copied from window.story.restorebecause reviver  //window.story.restore(hash) ;
...
var StatsDictionary = /*#__PURE__*/function (_Inventory) {
  ...
  var _super17 = _createSuper(StatsDictionary);
  ...
  function StatsDictionary(externlist) {
    ...
    _this16 = _super17.call(this, externlist);
  ...
  _createClass(StatsDictionary, [{
    ...
    key: "fromJSON",
    value: function fromJSON(value) {
      return window.storage.Generic_fromJSON(StatsDictionary, value.data);
    }
  }]);
...
var stArousal = /*#__PURE__*/function (_Stat) {
  _inherits(stArousal, _Stat);

  var _super18 = _createSuper(stArousal);
...
var stPerversion = /*#__PURE__*/function () {
  ...
  _createClass(stPerversion, null, [{
    ...
    value: function setup(context, base, max) {
      ...
      if (context.findItemSlot(_n.id) < 0) context.list.push(_n);
      _n = Stat.dataPrototype();
      _n.id = 'perversion', _n.hidden = 4, _n.base = base, _n.value = base, _n.limits = [{
        max: 'perversionMax',
        min: ''
      }];
      if (context.findItemSlot(_n.id) < 0) context.list.push(_n);
...
var Effects = /*#__PURE__*/function (_Inventory2) {
  ...
  var _super19 = _createSuper(Effects);
  ...
  function Effects(externlist) {
    ...
    _this17 = _super19.call(this, externlist);
  ...
  _createClass(Effects, [{
    ...
    key: "fromJSON",
    value: function fromJSON(value) {
      return window.storage.Generic_fromJSON(Effects, value.data);
    }
  }]);
...
var CombatEffect = /*#__PURE__*/function (_Effect) {
  ...
  var _super20 = _createSuper(CombatEffect);
  ...
  _createClass(CombatEffect, null, [{
    key: "onCombatEnd",
    //duration in turns !
...
var effEnergized = /*#__PURE__*/function (_Effect2) {
  ...
  var _super21 = _createSuper(effEnergized);
...
var effNotTired = /*#__PURE__*/function (_Effect3) {
  ...
  var _super22 = _createSuper(effNotTired);
...
var effTired = /*#__PURE__*/function (_Effect4) {
  ...
  var _super23 = _createSuper(effTired);
...
var skCooking = /*#__PURE__*/function (_Effect5) {
  ...
  var _super24 = _createSuper(skCooking);
...
var skAnalReceiving = /*#__PURE__*/function (_Effect6) {
  _inherits(skAnalReceiving, _Effect6);

  var _super25 = _createSuper(skAnalReceiving);

  function skAnalReceiving() {
    _classCallCheck(this, skAnalReceiving);

    return _super25.apply(this, arguments);
  }

  _createClass(skAnalReceiving, null, [{
    key: "dataPrototype",
    value: function dataPrototype() {
      return {
        id: skAnalReceiving.name,
        name: skAnalReceiving.name,
        time: 0,
        duration: 0,
        hidden: 0
      };
    ...
    get: function get() {
      return 'AnalReceiving';
    }
  }, {
    key: "desc",
    get: function get() {
      return skAnalReceiving.name;
    }
  }]);

  return skAnalReceiving;
}(Effect);

var effStunned = /*#__PURE__*/function (_CombatEffect) {
  _inherits(effStunned, _CombatEffect);

  var _super26 = _createSuper(effStunned);
  ...
  _createClass(effStunned, null, [{
    key: "dataPrototype",
    value: function dataPrototype() {
      return {
        id: effStunned.name,
        name: effStunned.name,
        time: 0,
        duration: 2,
        hidden: 0
      };
    ...
    key: "onCombatEnd",
    value: function onCombatEnd(context, data) {
      context.removeItem(data.id);
    }
  }, {
    key: "onTurnStart",
    value: function onTurnStart(context, data) {
      data.duration -= 1;
